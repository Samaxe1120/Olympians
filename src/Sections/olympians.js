        ...
        componentWillMount(){
            ...
            <div  onMouseEnter = {this.zeushoverBio} onMouseLeave = {this.zeushoverLeave} className= 'section1'>
             <h1 className = 'title'> Zeus: King of the Gods</h1>
              <img className = 'zeus' alt='Zeus' src = 'https://d1u5p3l4wpay3k.cloudfront.net/smite_gamepedia/thumb/e/e3/SkinArt_Zeus_Default.jpg/250px-SkinArt_Zeus_Default.jpg?version=631384ff4d91502fff20fde3d862b134'/>          
                    <div className ='biodiv allbiodiv'>
   ...
   class Poseidon extends Component {
       ...
       componentWillMount(){
           ...
           poseidonhoverBio = (props) => {
              ...
              render(){
return(
    <div style = {{opacity: this.poseidonhoverBio ? 1 : 0, color: this.poseidonhoverBio ? 'light' : 'lightcyan'}} onMouseEnter = {this.poseidonhoverBio}  onMouseLeave = {this.poseidonhoverLeave}  className = 'section2'>
     <h1 className= 'title2'> Poseidon: God of the sea  </h1>
     <img className = 'poseidon pics ' alt = 'Poseidon' src='https://vignette.wikia.nocookie.net/unnaturalworld/images/4/47/Poseidon_God_of_the_Seas.jpg/revision/latest?cb=20171027034757'/>
           <div className ='biodiv2 allbiodiv'>
...
class Hades extends Component {
    ...
    return(
        ...
        <h1 className= 'title3'>Hades: Lord of the Underworld </h1>
           <img className = 'hades pics' alt = 'Hades' src='https://vignette.wikia.nocookie.net/dresdenfiles/images/a/ad/Hades_small_by_jasonengle-dattd4i.jpg/revision/latest?cb=20170730081532'/>
        <div className ='biodiv3 allbiodiv'>
...
class Aphrodite extends Component{
    ...
    return(
        ...
        <img className = 'aphrodite pics' alt = 'Aphrodite' src='http://www.greekboston.com/wp-content/uploads/2014/10/87821072.jpg'/>
        <div  className ='biodiv4 allbiodiv'>
...
class Artemis extends Component{
 ...
 return(
     ...
     <img className = 'artemis pics' alt = 'Artemis' src='http://majorolympians.com/Artemis01L.jpg'/>  
     <div  className ='biodiv5 allbiodiv'>
